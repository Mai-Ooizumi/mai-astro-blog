...
<div bind:this={searchBar} class="search-bar hidden lg:block">
  <div class="bg-black/5 dark:bg-white/5 h-10 rounded-lg flex flex-row">
    ...
    <input
      id="search-bar-input"
      class="w-36 text-(--text-color) xl:focus:w-60 bg-transparent outline-none transition-all"
...
<div
  ...
  class="max-h-[436px] overflow-y-scroll opacity-0 absolute! h-0 -right-3 w-md bg-(--card-color) rounded-2xl top-20 transition-all"
>
  <div
